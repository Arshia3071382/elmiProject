          ...
          <div className="relative min-h-[220px] flex items-center justify-center">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-row flex-wrap sm:flex-nowrap items-center justify-between pt-4 border-t border-slate-100 gap-y-3">
                  {/* راست: پروفایل کاربر و ستاره‌ها زیر نام */}
                  <div className="flex flex-row items-center gap-2 text-right justify-start">
                  ...
                  {/* بخش چپ و وسط */}
                  <div className="flex flex-row w-full sm:w-auto items-center justify-between sm:justify-end gap-4 border-t sm:border-t-0 pt-2 sm:pt-0 border-slate-100">
                    {/* وسط: نام دوره آموزشی */}
