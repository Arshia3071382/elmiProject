// Hero logo with animation cycle
"use client";
...
export default function HeroLogo({ logo }: HeroLogoProps) {
  ...
  // Animation cycle: Logo (7s) -> Typography (4s) -> repeat
  useEffect(() => {
          ...
          {showTypography && (
            <motion.div
              ...
              className="
                ...
                h-[54px] w-[190px] sm:h-[60px] sm:w-[220px]
              "
            >
              <motion.div
                initial={{ clipPath: "inset(0 100% 0 0)" }}
                animate={{ clipPath: "inset(0 0% 0 0)" }}
                transition={{ duration: 2.0, delay: 0.1, ease: [0.16, 1, 0.3, 1] }}
              ...
              >
                <Image
                  ...
                  priority
                  sizes="220px"
                  className="object-contain drop-shadow-[0_3px_10px_rgba(37,99,235,0.12)]"
                />
              </motion.div>
            </motion.div>
          )}
