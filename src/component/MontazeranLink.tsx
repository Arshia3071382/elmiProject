  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-8 sm:mt-30">
      ...
      >
        ...
        {/* محتوای اسلایدر با ارتفاع ثابت */}
        <div className="relative z-10 flex flex-col items-center justify-between min-h-[160px] sm:min-h-[200px] py-1 sm:py-2">
          <div className="w-full flex items-center justify-center flex-1">
            <AnimatePresence mode="wait">
              {currentSlide === 0 ? (
                ...
                /* صفحه دوم: ورود به سایت منتظران - دو ردیف در موبایل */
                <motion.div
                  key="slide-2"
                  initial={{ opacity: 0, y: 15 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  <a
                    ...
                    "
                  >
                    {/* ردیف بالا: لوگو + تایتل - در موبایل */}
                    <div className="flex items-center gap-3 sm:gap-12 w-full sm:w-auto justify-center sm:justify-start">
                      {/* لوگو */}
                      <motion.div
                        className="
                          relative
                      ...
                      >
                        <Image
                          ...
                          alt="مجموعه منتظران"
                          fill
                          sizes="(max-width: 640px) 50px, 120px"
                          className="
                            object-contain
                      ...
                      {/* تایتل - در موبایل هم نمایش داده میشه */}
                      <motion.div 
                    ...
                    {/* ردیف پایین: زیرنویس + آیکون - در موبایل */}
