...
export const SCIENTIFIC_LEVELS = [
  { minScore: 0, maxScore: 500, title: "بدون سطح", icon: "/image/levels/le7.png" },
...
export const getScientificBadgeInfo = (score: number) => {
  if (score <= 500) return { title: "باید بیشتر تلاش کنی", imageUrl: "/image/levels/le7.png", levelIndex: 0 };
