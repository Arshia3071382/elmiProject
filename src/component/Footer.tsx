...
function Footer() {
  return (
    <div className="font-[iranSans-r]">
      <div className="bg-primary w-full sm:h-50 mt-20 rounded-t-full">
        <Container>
         ...
         <div className="flex sm:hidden flex-col justify-center items-center">
            <div>
              <div className="text-white text-center flex flex-col  items-center gap-3 mt-5">
                <h2>دسترسی سریع</h2>
              ...
              <div className="flex items-center gap-1 mt-3  sm:mb-15 justify-end">
                ...
                <Link
                  href={
                    "https://rubika.ir/elmiMontazeran"
                  }
                >
                  <Image width={30} src={rubika} alt="rubikaIcon" />
                </Link>
