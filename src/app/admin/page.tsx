...
import AdminChatTopicPanel from "./../../component/adminpaneldet/AdminTopicsPanel";
...
export default function AdminPage() {
  ...
  const fetchChatTopics = useCallback(async () => {
    const res = await fetch("/api/chat/topics").then(r => r.json()).catch(console.error);
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 font-sans">
      ...
      {/* بخش پنل مدیریت دپارتمان‌ها و موضوعات مشاوره */}
      <div className="max-w-7xl mx-auto px-6 pb-6">
        <AdminChatTopicPanel />
      </div>
