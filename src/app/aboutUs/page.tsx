...
const timelineData = [
  ...
  { year: "1402", title: "آشنایی دانش آموزان برتر با دستاوردهای علمی کشور", description: "یه اردوی جذاب  برای دانش آموزان ممتاز سال تحصیلی ، تو این اردو با دستاوردهای صنعت نظامی کشور آشنا شدیم و روحیه خودباوری  و خودکفایی در بچه ها بیشتر شد", icon: Award, images: ["/image/ordoP.jpg" , "/image/ordoP2.jpg" , "/image/ordoP3.jpg"]  },
];
