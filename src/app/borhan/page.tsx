...
export default function BorhanPage() {
  ...
  if (isAdminView) {
    if (adminLoading)
      return (
        <div className="p-6 text-center text-gray-500 font-bold" dir="rtl">
        ...
        <div className="flex justify-between  mt-10 sm:mt-100 items-center border-b border-gray-100 pb-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              اعلام آمادگی مدرسان و دانش‌آموزان برای حضور در پروژه بزرگ علمی
            </p>
          </div>
          <button
              ...
              {members.length === 0 ? (
                ...
                members.map((m) => (
                  <tr key={m._id} className="hover:bg-gray-50/80 transition">
                    <td className="p-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-black ${m.role === "teacher" ? "bg-blue-50 text-[#2563EB] border border-blue-200" : "bg-indigo-50 text-indigo-700 border border-indigo-200"}`}
                      >
                        {m.role === "teacher"
                          ? "👨‍🏫 مربی فیزیک"
                          : "🎓 دانش‌آموز"}
                    ...
                    <td className="p-4 text-gray-500 max-w-xs truncate">
                      {m.background || m.interests || m.honors || "-"}
                    </td>
  ...
  return (
    <div
      className="relative min-h-screen bg-[#F8FAFC] text-[#0F172A] overflow-hidden font-sans"
      dir="rtl"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-20 flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-tight mb-8">
          جایی که فرمول‌ها به <span className="aurora-text">پرواز</span>{" "}
          درمی‌آیند!
        </h1>

        <p className="max-w-3xl text-lg md:text-2xl text-[#475569] leading-relaxed mb-12 font-medium">
          دوست عزیز فیزیک‌دان؛ چه معلمی مشتاق کهکشانی از ایده‌ها باشی، و چه
          دانش‌آموزی که ستاره‌ها را نشانه گرفته‌است، تیم «برهان» قراره یک تحول
          بزرگ و بی‌نظیر رو رقم بزنه. ما داریم فضایی می‌سازیم که فیزیک رو نه روی
          کاغذ، بلکه با تمام وجود لمس کنی. آماده‌ایم تا با هم دنیای علم رو متحول
          کنیم؟
        </p>
      ...
      {/* مودال چندمرحله‌ای راست‌به‌چپ (RTL) با اصلاح ریسپانسیو و اسکرول */}
      {isModalOpen && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-md p-4 overflow-y-auto"
          dir="rtl"
        >
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl max-w-lg w-full p-6 sm:p-8 relative border border-white/50 my-auto max-h-[90vh] flex flex-col animate-in fade-in zoom-in duration-200">
            {/* دکمه بستن (ضربدر در سمت چپ بالا) */}
            <button
              onClick={resetModal}
              className="absolute top-5 left-5 text-gray-400 hover:text-gray-700 text-2xl font-bold cursor-pointer transition-colors z-10"
            >
              ✕
            </button>

            {successMessage ? (
              <div className="text-center py-8 animate-in fade-in zoom-in duration-300 my-auto">
                ...
                <p className="text-[#475569] mb-8 font-medium leading-relaxed px-4">
                  به زودی از طریق{" "}
                  <span className="text-[#2563EB] font-bold">پیامک</span>{" "}
                  اطلاع‌رسانی‌های لازم جهت آغاز پرواز علمی برای شما ارسال خواهد
                  شد.
                </p>
                <button
                  onClick={resetModal}
              ...
              <div className="flex flex-col flex-1 overflow-hidden">
                ...
                {!role && (
                  <div className="animate-in fade-in duration-200 my-auto py-4">
                    <div className="text-center mb-8">
                      <span className="text-3xl mb-2 inline-block">🪐</span>
                      <h3 className="text-2xl font-black text-[#0F172A]">
                        به تیم کهکشانی برهان خوش آمدید
                      </h3>
                      <p className="text-gray-500 text-sm mt-1">
                        لطفاً برای شروع سفر، جایگاه خود را انتخاب کنید:
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-500 text-center">
                          راهبر و هدایت‌گر ستاره‌های آینده
                        </span>
                      </button>
                    </div>
                  </div>
                ...
                {role && (
                  <form
                    ...
                    className="animate-in fade-in duration-200 flex flex-col flex-1 overflow-hidden"
                  >
                    <div className="flex items-center justify-between mb-4 border-b border-gray-100 pb-4 shrink-0">
                      <div>
                        ...
                        <h3 className="text-xl font-black text-[#0F172A] mt-0.5">
                          {step === 1
                            ? "اطلاعات ارتباطی اولیه"
                            : "جزئیات تخصصی و انگیزشی"}
                        </h3>
                      </div>
                      <button
                        type="button"
                        ...
                        className="text-xs font-bold text-gray-400 hover:text-[#2563EB] transition cursor-pointer bg-gray-50 px-3 py-1.5 rounded-lg border border-gray-100 ml-6"
                      >
                        تغییر نقش
                      </button>
                    </div>
                    ...
                    {/* محتوای فرم با قابلیت اسکرول برای جلوگیری از مخفی شدن دکمه‌ها */}
                    <div className="flex-1 overflow-y-auto px-1 custom-scrollbar space-y-4 py-2">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 rounded-xl border focus:outline-none bg-white font-medium transition ${
                                errors.fullName
                                  ...
                                  : "border-gray-200 focus:ring-2 focus:ring-[#2563EB]"
                              }`}
                      ...
                      {step === 2 && role === "student" && (
                        <div className="space-y-4">
                          ...
                          <div>
                            <label className="block text-sm font-bold text-[#0F172A] mb-1">
                              علاقمندی‌ها و انگیزه حضور در برهان
                            </label>
                            <textarea
                              name="interests"
                              rows={3}
                    ...
                    {/* دکمه‌های کنترل پایین فرم (همیشه ثابت و در دسترس) */}
                    <div className="pt-4 mt-2 border-t border-gray-100 shrink-0">
                      {step === 1 ? (
                        <button
                          type="button"
                          onClick={handleNextStep}
                          className="w-full py-4 bg-gradient-to-r from-[#1F3A5F] to-[#2563EB] text-white font-black rounded-xl hover:opacity-95 transition cursor-pointer shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2"
                        >
                        ...
                        <div className="flex gap-3">
                          ...
                          <button
                            type="submit"
                            disabled={loading}
                            className={`w-2/3 py-3.5 text-white font-black rounded-xl hover:opacity-95 transition cursor-pointer shadow-lg ${
                              role === "teacher"
                                ? "bg-gradient-to-r from-[#2563EB] to-[#38BDF8] shadow-blue-500/20"
