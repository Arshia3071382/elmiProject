      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-slate-50/80 via-white to-slate-50/60 relative overflow-hidden dir-rtl font-[iranSans-r] min-h-screen">
        ...
        >
          ...
          <p className="text-slate-600 text-xs sm:text-sm">
            برنامه‌ریزی دقیق کلاس‌ها و آزمون‌های ماهانه
          </p>
        </motion.div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between pb-3 border-b border-slate-200/60 mb-3">
                    ...
                    <div>
                      {eventData && (
                        <span
                          className={`text-[11px] px-2.5 py-1 rounded-lg font-medium inline-block ${
                            eventData.type === "exam"
                  ...
                  <div className="text-center py-2">
                    {eventData ? (
                      <div className="flex flex-col items-center justify-center gap-2">
                        <span className="font-[iranBold] text-sm sm:text-base text-slate-900">
                          {eventData.title}
                        </span>
                        {eventData.hour && (
